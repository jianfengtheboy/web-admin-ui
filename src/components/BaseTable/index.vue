		...
		<a-row justify="space-between" align="center">
			<a-space wrap>
				<slot name="custom-title">
					<div class="base-table-title">{{ props.title }}</div>
				</slot>
			</a-space>
			<a-space wrap>
				...
				<a-space wrap :size="[14, 0]">
					...
					<a-dropdown @select="handleSelect">
						<a-tooltip content="表格尺寸">
							<a-button size="mini" class="base-table-btn">
								<template #icon>
									<icon-table-size />
								</template>
							</a-button>
					...
					>
						...
						<template #content>
							<div class="base-table-draggable box-border">
								<VueDraggable v-model="settingColumnList">
									<div
										v-for="item in settingColumnList"
										:key="item.title"
										class="drag-item flex items-center cursor-pointer"
									>
										<div class="drag-item__move cursor-move">
