...
const onViewAction = (item: IDictItem) => {
	dictDataRef.value && dictDataRef.value?.open({ code: item.code })
}
</script>
		...
		<div class="main-content">
			...
			>
				<template #columns>
					...
					<a-table-column title="字典名称" align="center" data-index="name" />
					<a-table-column title="字典编码" align="center" data-index="code" />
					...
					<a-table-column title="描述" align="center" data-index="description" />
